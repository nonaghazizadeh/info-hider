...
class AddressExtraction(object):
    def __init__(self):
        ...
        self.starter_keywords = f"{self.start_address_keywords}|{self.locations}"
        ...
        self.pattern = f"((({self.locations})|(({self.start_address_keywords})(\W+)(\w+)))(({self.separators})+))+"
